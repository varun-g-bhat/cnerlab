...
const AdminPermission: React.FC = () => {
  ...
  const fetchPermissions = async () => {
    setLoading(true);
    try {
      let url = "https://cnerlab-1.onrender.com/api/v1/permission/";

      switch (activeTab) {
        case "pending":
          url = "https://cnerlab-1.onrender.com/api/v1/permission/pending";
          break;
        case "approved":
          url = "https://cnerlab-1.onrender.com/api/v1/permission/approved";
          break;
        case "rejected":
          url = "https://cnerlab-1.onrender.com/api/v1/permission/rejected";
          break;
      }
  ...
  const handleApprove = async (permissionId: string) => {
    ...
    try {
      await axios.put(
        `https://cnerlab-1.onrender.com/api/v1/permission/approve/${permissionId}`,
  ...
  const handleReject = async (permissionId: string) => {
    ...
    try {
      await axios.put(
        `https://cnerlab-1.onrender.com/api/v1/permission/reject/${permissionId}`,
        { withCredentials: true }
      );
